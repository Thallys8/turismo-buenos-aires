...
- [feature/tester-qa-js-testing-suite] Se creó y agregó los archivos de las puebas Jamine y Lighthouse.  
...
- [feature/dev-async-fetch-api] Correción de las targetas para mostrar los imagenes representativos de las atracciones y de google maps según mockup, y de los errores en consola al momento de finalizar la reserva.  
PR: [#138](https://github.com/Thallys8/turismo-buenos-aires/pull/138) @Thallys8 (Desarrollador JS Asíncrono + Tester QA/JS ).
- [feature/dev-async-fetch-api] Correción definitiva de las iimagenes y creacin del constructor de reservas.    
...
- [feature/dev-js-clases-oop-y-puml] Correccion de errores generales en js  
...
- [feature/release-correcciones-js] Clases Javascript OOP y documentacion de clases  
PR: [#109](https://github.com/Thallys8/turismo-buenos-aires/pull/109) @Tomig02 (Desarrollador JS Eventos + DOM + Desarrollador JS POO). 
